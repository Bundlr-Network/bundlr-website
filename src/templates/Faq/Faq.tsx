...
const CTA: React.FC = () => {
  return (
    <div className="relative flex h-[616px] flex-col items-center justify-center overflow-hidden bg-black py-4 px-6 text-white">
      <h2 className="mb-11 max-w-[670px] text-center font-fkDisplay text-6xl font-light leading-none text-white">
        Can&apos;t Find What You&apos;re Looking For?
      </h2>
      <button className="flex items-center gap-3 rounded-full bg-white px-4 py-3 font-robotoMono text-sm uppercase text-black hover:font-bold">
        Ask us on discord
        <DiscordIcon className="w-5" />
      </button>

      <div className="absolute top-0 right-0 hidden rotate-180 transform overflow-hidden lg:flex">
        <img
      ...
      <div className="absolute top-0 left-0 hidden overflow-hidden lg:flex">
        <img
          src="/assets/community/cta-blocks-2.png"
          className="h-full w-full rounded-lg"
          alt="image2"
...
const useFaq = () => {
  ...
  const PAGE_SEO = {
    title: 'Bundlr | FAQs',
    description:
      'Get answers to your questions about Bundlr in our comprehensive FAQ. Clear and concise information for all levels of users.'
  }
  ...
  const FAQ_CONTENT = [
    {
      ...
      description:
        'Please follow us on <a className="underline" href="https://discord.gg/bundlr">Discord</a> and <a className="underline" href="https://twitter.com/BundlrNetwork">Twitter</a> to keep up with the latest updates and news.',
    ...
    },
    {
      ...
      description:
        'An incentivized/immutable storage protocol that lets users store their data permanently with a one-time fee. Arweave is a new type of storage that backs data with a sustainable and perpetual endowment, allowing users and developers to truly store data forever for the very first time.As a collectively owned hard drive that never forgets, Arweave allows us to remember and preserve valuable information, apps, and history indefinitely. By preserving history, it prevents others from rewriting it.',
      category: FaqCategory.General
    },
    {
    ...
    },
    {
      ...
      description:
        'Please check out <a className="underline" href="https://docs.bundlr.network/docs/overview">the Bundlr docs</a> to get a deeper understanding of how Bundlr works.',
      category: FaqCategory.General
    },
    {
    ...
    },
    {
      ...
      description:
        '`gateway.bundlr.network/tx/:txid/data` (Bundlr uploads only).Or, `arweave.net/<your transaction id>`',
      category: FaqCategory.General
    },
    {
    ...
    },
    {
      ...
      description:
        '<a className="underline" href="https://v2.viewblock.io/arweave">Arweave Explorer</a> | <a className="underline" href="https://v2.viewblock.io/arweave">ViewBlock</a><a className="underline" href="https://scar.vercel.app/">SCAR</a>',
      category: FaqCategory.General
    },
    {
    ...
    },
    {
      ...
      description:
        'We do not have a public token yet. Anyone claiming a presale, token airdrop, etc via DM is a scam. Please follow the announcements on <a className="underline" href="https://discord.gg/bundlr">Discord</a> and <a className="underline" href="https://twitter.com/BundlrNetwork">Twitter.</a>',
      category: FaqCategory.General
    },
    {
      title: 'What currencies does Bundlr support?',
      description:
        'Please <a className="underline" href="https://docs.bundlr.network/sdk/using-other-currencies">view all supported currencies here.</a>',
      category: FaqCategory.General
    },
    {
    ...
    },
    {
      ...
      description:
        'Bundlr registers funding / withdraw transactions off-chain in payment channels.Example: With Polygon, you will send MATIC and the Polygon tx is recorded off-chain which will credit your Polygon (MATIC) account on Bundlr.',
      category: FaqCategory.General
    },
    {
      title: 'How does the payment channel work?',
      description:
        'You can submit an on-chain transaction using the chains we support via their own cryptography.Then, this transaction is recorded off-chain by the bundlers and you receive the equivalent amount of token(s) in your Bundlr account.',
      category: FaqCategory.General
    },
    {
    ...
    },
    {
      ...
      description:
        'The funding process varies depending on which chain you use for funding and the speed of that network.Example: Funding with Arweave takes ~20 minutes to show up, whereas funding with Polygon/Solana can be pretty instant.',
      category: FaqCategory.General
    },
    {
      title: 'How does the fee function work on Bundlr?',
      description:
        'Please check out <a className="underline" href="https://docs.bundlr.network/learn/fees">the fee function here.</a>',
      category: FaqCategory.General
    },
    {
      title: 'Is there a calculator for Arweave fees?',
      description:
        '<a className="underline" href="https://ar-fees.arweave.dev/">Arweave Fees</a>',
      category: FaqCategory.General
    },
    {
    ...
    },
    {
      ...
      description:
        'Each node has different pricing. From network design, it creates competition.Higher Competition = Higher user value for money (to a point). Nodes do not share funding balances, you can only upload to a node you have funded.',
    ...
    },
    {
      ...
      description:
        'The Bundlr class is used for NodeJS applications on the server.Whereas WebBundlr is used in the browser. To learn more, we have tutorials on working with <a className="underline" href="/tutorials/bundlr-nodejs">Bundlr+NodeJS.</a>and <a className="underline" href="/tutorials/file-uploader">WebBundlr+React</a>',
      category: FaqCategory.Developer
    },
    {
      title: 'How do I use WebBundlr in a create-react-app project?',
      description:
        'Bundlr and WebBundlr are fully compatible with React. However, if you are using npx create-react-app, you will need to do a few extra steps when setting up your project. We have <a className="underline" href="/recipes/bundlr-react">a fully detailed recipe here.</a>',
      category: FaqCategory.Developer
    },
    {
      title: 'How do I use WebBundlr when working with RainbowKit?',
      description:
        'Internally, WebBundlr and RainbowKit use a slightly different Provider class with different function signatures. It is possible to make the classes compatible, however it takes one extra step. We have <a className="underline" href="/recipes/bundlr-rainbowkit">a detailed recipe here.</a>',
      category: FaqCategory.Developer
    },
    {
      title: 'Can I host a website using Bundlr?',
      description:
        'Yes. You can host static websites. We have <a className="underline" href="/recipes/bundlr-uploading-static-sites">a detailed recipe on how to do it here.</a>',
      category: FaqCategory.Developer
    },
    {
      title:
    ...
    },
    {
      ...
      description:
        'Server-Side Signing is a method that allows you to sign and pay for your user’s data securely without exposing your private key.You can <a className="underline" href="/recipes/server-side-signing">learn more about Server-Side Signing here.</a>',
      category: FaqCategory.Developer
    },
    {
    ...
    },
    {
      ...
      description:
        '<a className="underline" href="/learn/setup-validator-node">Here is a full guide.</a>',
      category: FaqCategory.Testnet
    },
    {
      title: 'What are the hardware requirements?',
      description:
        'Memory: 8GB RAM-   CPU: Quad-Core-   Disk: 250 GB SSD Storage-   Bandwidth: 1 Gps for download/ 100 Mbps for upload.',
      category: FaqCategory.Testnet
    },
    {
      title: 'Which wallet should I use for participating in the testnet?',
      description:
        'Arweave.appHere is <a className="underline" href="/tutorials/get-arweave-wallet">a tutorial on how to get an Arweave wallet</a>',
      category: FaqCategory.Testnet
    },
    {
    ...
    },
    {
      ...
      description:
        'No. In order to participate, you will receive testnet tokens <a className="underline" href="https://bundlr.network/faucet">from the Bundlr faucet.</a>',
      category: FaqCategory.Testnet
    },
    {
      title: 'Where can I get the test tokens?',
      description:
        'From <a className="underline" href="https://bundlr.network/faucet">the Faucet.</a> These tokens are NOT on the main Arweave blockchain, but you will need an Arweave wallet to receive them.',
      category: FaqCategory.Testnet
    },
    {
      title: 'Do I need to pass KYC for participating in the testnet?',
      description:
        'No. KYC is not required.However, you should verify your Twitter account in order to claim test tokensfrom <a className="underline" href="https://bundlr.network/faucet">the Faucet.</a>',
      category: FaqCategory.Testnet
    },
    {
    ...
    },
    {
      ...
      description:
        'Simply join our <a className="underline" href="https://discord.gg/bundlr">Discord channel</a> and post your tweet URL in #faucet-issues channel.Ps: Please note that you can ONLY verify 1 address with each Twitter account.',
      category: FaqCategory.Testnet
    },
    {
      title:
...
const ExpandableSection = ({
  ...
  return (
    <details className="border-spacing-4 border-b-[2.5px] border-dotted border-gray-400 pt-4 pb-8 last:border-b-0">
      <summary className="mt-[26px] flex cursor-pointer items-center justify-between font-fkDisplay text-2xl font-light">
        {title}
        <PlusFooterDetailIcon />
        <MinusFooterDetailIcon />
      </summary>
      <p
        className="mt-5 font-robotoMono"
...
const Faq: NextPage = () => {
  ...
  return (
    <>
      ...
      <NavbarDesktop />
      {/* Categories filter  */}
      <section className="ml-auto mr-auto max-w-[976px]">
        <div className="flex flex-col items-start justify-between gap-4 px-4 pb-9 pt-32 lg:flex-row lg:items-center lg:gap-0">
          <h1 className="font-fkDisplay text-5xl font-light">FAQs</h1>
          {/* search box with icon on left of the input area */}
          <div className="flex w-full items-center gap-3 rounded-full border border-gray-400 py-2 px-4 font-robotoMono text-lg lg:w-auto">
        ...
        <div
          ...
          className={`mx-4 mt-8 flex cursor-pointer items-center justify-between bg-black p-[15px] font-robotoMono text-sm font-bold uppercase text-white lg:hidden lg:p-[5px]`}
        >
          {
          ...
          <ChevronDownIcon
            className={`w-5 transition-all ${
              mobileExpanded ? 'rotate-180 transform' : ''
            }`}
          />
        </div>
        {mobileExpanded && (
          <ul className="flex-col items-center justify-between px-4 pt-2 lg:hidden lg:flex-row lg:px-0">
              ...
              return (
                ...
                ${
                  ...
                  Object.keys(FaqCategory).find(
                    ...
                    ? 'cursor-default bg-black font-bold text-white'
                    : ''
                } w-full cursor-pointer p-[15px] font-robotoMono text-sm uppercase lg:w-auto lg:p-[5px]
        ...
        <ul className="hidden flex-col items-center justify-between px-4 pt-12 lg:flex lg:flex-row lg:px-0">
          {Object.values(FaqCategory).map((key) => {
            return (
              <li
                key={key}
        ...
        <ul className="px-4 pt-4 lg:px-0 lg:pt-12">
          {FAQ_CONTENT.sort(
