  ...
  return (
    <>
      <section className="mx-4 lg:mx-[79px] rounded-[30px] overflow-hidden h-[473px] relative bg-black text-white flex items-center">
        ...
        <img src="/new/assets/home/data-sphere.webp" alt="" className="absolute -bottom-[350px] md:-bottom-[520px] lg:bottom-auto md:-left-[420px] xl:-left-[350px] block w-[600px] md:w-[800px]" />
